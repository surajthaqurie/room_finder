...
import { BadRequestError, ConflictRequestError, NotFoundError, paginationQuery } from "src/utils";
...
export class UserService {
    ...
    public async enableDisableUser(id: string) {
        ...
        if (!enableDisable) throw new BadRequestError(user.isDeleted ? USER_MESSAGE_CONSTANT.UNABLE_TO_DISABLE_USER : USER_MESSAGE_CONSTANT.UNABLE_TO_ENABLE_USER);
